...
class Encontrista(models.Model):
    ...
    religiao_mae = models.CharField(max_length=60, null=False, blank=False, verbose_name='religiao_mae')
    email = models.EmailField(max_length=50, null=False, blank=False, verbose_name='email')
    facebook = models.EmailField(max_length=50, null=False, blank=False, verbose_name='facebook')
    naturalidade = models.CharField(max_length=40, null=False, blank=False, verbose_name='naturalidade')
    cpf = models.CharField(unique=True, max_length=15, null=True, blank=False, verbose_name='cpf')
    ...
    telefone_trabalho = models.CharField(max_length=20, null=True, blank=False, verbose_name='telefone_trabalho')
    ...
    nome_facebook = models.CharField(max_length=150, null=True, blank=True, verbose_name='nome_facebook')
    nome_instagram = models.CharField(max_length=150, null=True, blank=True, verbose_name='nome_instagram')
